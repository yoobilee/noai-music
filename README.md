...
현재는 기술 설계와 최소 실행 뼈대에 더해 YouTube watch 페이지의 공식 AI disclosure 감지와 YouTube 영상 카드 video ID 추출 vertical slice를 구현한 단계입니다. 감지 결과에는 개발 검증용 배지만 표시하며 숨김, 흐림과 자동 건너뛰기는 아직 구현하지 않았습니다.
